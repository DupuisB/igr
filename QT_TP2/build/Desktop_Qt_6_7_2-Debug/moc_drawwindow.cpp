...
struct qt_meta_stringdata_CLASSDrawWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDrawWindowENDCLASS = QtMocHelpers::stringData(
    "DrawWindow",
    "mousePressEvent",
    "",
    "QMouseEvent*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDrawWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DrawWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSDrawWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDrawWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDrawWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DrawWindow, std::true_type>,
...
void *DrawWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDrawWindowENDCLASS.stringdata0))
